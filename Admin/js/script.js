...
$(function() {
        ...
        $.ajax({
            ...
            success: function(resp) {
                ...
                if (resp.status == 'success') {
                    ...
                    _modal.find('#name_a2').val(data.name_a)
                    data.audio_path = (data.audio_path).replace("/projects/Admin/audio/", "");
    ...
    $('.delete').click(function() {
        ...
        if (conf === true) {
            location.replace("/Admin/view/delete_img.php?id=" + id)
        }
    })
    $('.play').click(function() {
        var _this = $(this)
            ...
            $.ajax({
                ...
                success: function(resp) {
                    ...
                    if (resp.status == 'success') {
                        ...
                        $('#inplay-name_a').text(data.name_a);
