  ...
  <!-- dashboard -->
    <nav>
      <!<div class="logo" style="font-size:30px">
        ...
        <span class="logo-name">G8 Music </span>
      </div>
      <div class="sidebar">
        <div class="logo">
          <!-- <i class="bx bx-menu menu-icon"></i> -->
          <img src="../H_IMGAES/logo.png" alt="" style="width:180px" >
          <p  class="logo-name" style="font-size:18px">
            <?php
                if(isset($_SESSION["Name"])) {
                    echo "<span>"?>
                    <?php   echo "<span>Xin chào " . $_SESSION["Name"] .    "    !</span>";?>
                    <?php 
                    echo "</span>";
                }
                else 
        ...
        <div class="sidebar-content">
          <ul class="lists">
            <li class="list">
              <a href="index.php?pid=1" class="nav-link">
            ...
            <li class="list">
              <a href="index.php?pid=2" class="nav-link">
          ...
          <!-- <div class="bottom-cotent">
            ...
            <li class="list" style="padding-bottom:70px">
