                 ...
                 <div class="mlist__">
                        <div class="">
                            <div class="added">
                                ...
                                <div class="search">
                                <input id="search-box" type="text" placeholder="Bạn muốn nghe gì hôm nay?">
                                <a href="#" onclick="searchSongs()" class="btn btn-default search"><i class="fa fa-search"></i></a>
                            </div>
