...
$(function() {
    ...
    function playMusic(button) {
        // Lấy ID của bài hát từ thuộc tính data-id của nút phát
        var musicId = button.getAttribute('data-id');
        
        // Thực hiện các hành động khác liên quan đến việc phát nhạc
        // Ví dụ: Gửi yêu cầu AJAX để phát nhạc có ID là musicId
        // và thực hiện các hành động khác mà bạn cần
    }
})